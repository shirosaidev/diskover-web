...
function get_file_ext($client, $path, $filter, $mtime) {
	// gets the top 10 file extensions in the current directory (path)
	$items = [];
  $searchParams['body'] = [];
...
$data = [
            ...
            "size" => $dirinfo[0],
						"count" => $dirinfo[1],
            "children" => get_file_ext($client, $path, $filter, $mtime)
          ];
