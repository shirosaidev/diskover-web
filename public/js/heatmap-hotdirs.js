...
function getESJsonDataHeatMap() {
    ...
    var chartConfig = {
        ...
        data_url1: 'd3_data_hm.php?index=' + index + '&path=' + encodeURIComponent(path) + '&filter=' + filter + '&mtime=' + mtime + '&maxdepth=' + maxdepth + '&use_count=' + use_count + '&show_files=0',
        data_url2: 'd3_data_hm.php?index=' + index2 + '&path=' + encodeURIComponent(path) + '&filter=' + filter + '&mtime=' + mtime + '&maxdepth=' + maxdepth + '&use_count=' + use_count + '&show_files=0'
    };
...
if (index2 === "") {
    ...
    // d3 treemap
    var w = parseInt(d3.select('#heatmap-wrapper').style('width'), 10) - 15,
        h = parseInt(d3.select('#heatmap-wrapper').style('height'), 10) - 15,
