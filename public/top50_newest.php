...
$newestdirs = $queryResponse['hits']['hits'];
  ...
  <div class="row">
    <div class="col-xs-12">
        <div id="top50files">
            <div class="row">
    			<div class="col-xs-12">
    				<h2 style="display: inline;"><i class="glyphicon glyphicon-scale"></i> Top 50 Newest Files</h2>&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" onclick="top50Switch('directory');">Switch to directories</a>&nbsp;&nbsp;&nbsp;&nbsp;
                    <div class="btn-group">
                    ...
                    <span><a title="<?php echo getParentDir($path); ?>" class="btn btn-primary btn-sm" onclick="window.location.href='top50_newest.php?path=<?php echo getParentDir($path); ?>&amp;filter=<?php echo $_GET['filter']; ?>&amp;mtime=<?php echo $_GET['mtime']; ?>&amp;doctype=<?php echo $_GET['doctype']; ?>';"><i class="glyphicon glyphicon-circle-arrow-up"></i> Up level</a></span>
                </div>
    		</div><br />
        ...
        <div id="top50dirs" style="display:none;">
            <div class="row">
    			<div class="col-xs-12">
    				<h2 style="display: inline;"><i class="glyphicon glyphicon-scale"></i> Top 50 Newest Directories</h2>&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" onclick="top50Switch('file');">Switch to files</a>&nbsp;&nbsp;&nbsp;&nbsp;
                    <div class="btn-group">
                        <button class="btn btn-default button-largest"> Largest</button>
                        <button class="btn btn-default button-oldest"> Oldest</button>
                        <button class="btn btn-default button-newest active"> Newest</button>
