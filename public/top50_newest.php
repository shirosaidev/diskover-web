  ...
  <div class="row">
    <div class="col-xs-12">
        <div id="top50files">
            <div class="row">
    			<div class="col-xs-12">
    				<h1 style="display: inline;"><i class="glyphicon glyphicon-scale"></i> Top 50 Newest Files</h1>&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" onclick="top50Switch('directory');">Switch to directories</a></h1>&nbsp;&nbsp;&nbsp;&nbsp;<h5 style="display: inline;">Path: <span class="text-success"><?php echo stripslashes($path); ?></span></h5>&nbsp;&nbsp;&nbsp;&nbsp;
                    <div class="btn-group">
        ...
        <div id="top50dirs" style="display:none;">
            <div class="row">
    			<div class="col-xs-12">
    				<h1 style="display: inline;"><i class="glyphicon glyphicon-scale"></i> Top 50 Newest Directories</h1>&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" onclick="top50Switch('file');">Switch to files</a></h1>&nbsp;&nbsp;&nbsp;&nbsp;<h5 style="display: inline;">Path: <span class="text-success"><?php echo stripslashes($path); ?></span></h5>
                    <div class="btn-group">
                        <button class="btn btn-default button-largest"> Largest</button>
                        <button class="btn btn-default button-oldest"> Oldest</button>
                        <button class="btn btn-default button-newest active"> Newest</button>
