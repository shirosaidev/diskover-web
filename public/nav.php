    ...
    <ul class="nav navbar-nav">
      ...
      <li class="dropdown">
        ...
        <ul class="dropdown-menu" role="menu">
          ...
          <li class="divider"></li>
          <li><a href="/advanced.php?submitted=true&amp;p=1&amp;last_access_time_high=<?php echo gmdate("Y-m-d\TH:i:s", strtotime("-3 months"));?>">All files last accessed > 3 months</a></li>
          <li><a href="/advanced.php?submitted=true&amp;p=1&amp;last_access_time_high=<?php echo gmdate("Y-m-d\TH:i:s", strtotime("-6 months"));?>">All files last accessed > 6 months</a></li>
          <li><a href="/advanced.php?submitted=true&amp;p=1&amp;last_access_time_high=<?php echo gmdate("Y-m-d\TH:i:s", strtotime("-12 months"));?>">All files last accessed > 1 year</a></li>
          <li class="divider"></li>
          ...
          <li><a href="/advanced.php?submitted=true&amp;p=1&amp;is_dupe=true">All duplicate files</a></li>
			...
			<li><a href="/sunburst.php?path=/">File Tree</a></li>
    </ul>
