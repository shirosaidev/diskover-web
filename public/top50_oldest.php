  ...
  <div class="row">
    <div class="col-xs-12">
        <div id="top50files">
            <div class="row">
    			<div class="col-xs-12">
    				<h1 style="display: inline;"><i class="glyphicon glyphicon-scale"></i> Top 50 Oldest Files</h1>&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" onclick="top50Switch('directory');">Switch to directories</a></h1>&nbsp;&nbsp;&nbsp;&nbsp;
                    <div class="btn-group">
        ...
        <div id="top50dirs" style="display:none;">
            <div class="row">
    			<div class="col-xs-12">
    				<h1 style="display: inline;"><i class="glyphicon glyphicon-scale"></i> Top 50 Oldest Directories</h1>&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" onclick="top50Switch('file');">Switch to files</a></h1>&nbsp;&nbsp;&nbsp;&nbsp;
                    <div class="btn-group">
                        <button class="btn btn-default button-largest"> Largest</button>
                        <button class="btn btn-default button-oldest active"> Oldest</button>
                        <button class="btn btn-default button-newest"> Newest</button>
