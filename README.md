...
diskover-web is the web file manager for [diskover](https://github.com/shirosaidev/diskover), allowing you to search Elasticsearch for your indexed files and tag them for deletion, archival or keeping. Custom tags for files is also supported. It is written in PHP, [Bootstrap](http://getbootstrap.com/), [jQuery](https://jquery.com/) and [D3.js](https://d3js.org).
